...
@section('contenu')
    ...
    <div style="display: flex;" >
          ...
          @auth
                          ...
                          <a style="text-decoration: none" href="{{ route('detailacteurs.index', [$acteurs->id]) }}">
                            <div style="width: 130px;">
                                  <div style="width: 100%;
                                    ...
                                    background-size: cover;" > </div>
                                  <h3 style="font-size: 15px;margin-left: 10px;color: white;">{{$acteurs->nom_complet}}</h3>
                            </div>
                          </a>
                        @endforeach 
                    </div >
            ...
            @auth      
            <a href="{{ route('ajoutrelation.index', [$film->id]) }}" style="text-decoration: none ;margin-left:30px;;"><h3 style="font-size: 15px;color: rgb(0, 255, 64);">Ajouter un acteur</h3></a>
            <a href="{{ route('supprrelation.index', [$film->id]) }}" style="text-decoration: none;"><h3 style="font-size: 15px;color: rgb(255, 0, 0);">Suprimer un acteur</h3></a>
            @endauth
